...
There was one day near Oct 2022 that had over 25 calls and certainly presents itself as an outlier. There is also a dip in the end of the data which is around winter time, showing that there are less drug overdoses in the wintertime
...
I had noticed that there were 5 days where more than 20 calls were placed, but I visually thought those were the unusually high days. However, using the z scores, it shows that there are more days than those that would fit into the unusually high category.
...
Tuesday, Oct 4 had the highest amount of calls over the course of the last year. This puts that particular days that there is a 5% chance for this number of calls to occur on a given day.
...
Some next steps might be to start researching specific days. You could go through police reports to find out more information about what happened on those days. There is potential for a bad batch of drugs. If the police siezed any of these, perhaps there is a report on it and it can be correlated to the days with an abnormally high number of calls. Some angles for reporting might be to find if there are any trends in bad batches or to track where the drugs are coming from to discover whre specific the bad batch originated. 
