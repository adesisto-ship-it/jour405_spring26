...
It is generally a normal distribution (about 80% normal) because the bulk of the data is fairly close to the mean. 68% of the data falls within one SD from the mean and ranges from about 8 to 17 car thefts.
