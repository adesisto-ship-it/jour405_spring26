...
Maryland is in the 95th percentile of all 343 teams in terms of total aces that year. This means that Maryland, with 223 aces, sits in the top 5% of all of the teams in the NCAA. Penn State won the championship that year which is interestingly in the 87% percentile in 2024. One of the big reasons might be Sam Schnitta, who is a pin hitter, and might be part of the reason for it give that she set the program record for aces that year.
