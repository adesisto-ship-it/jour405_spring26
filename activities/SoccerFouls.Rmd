...
The corellation is so close to 0 that there is essentially no correlation. The scatterplot shows the same since there is a nearly horizontal line and the data has no real relationship or trend in any direction.
...
There is ever so slightly more correlation compared to the fouls, but it is still extremely close to zero and therefore shows no actual correlation between yellow cards and the goals scored in a game.
