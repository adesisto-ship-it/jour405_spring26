...
The correlation calculation is sitting at about .5 which is not bad but not awful. Given the scatterplot, it seems as though there is just limited data to really see a correlation. The data is fairly all over the place byt seems to have a general upward trend. I would say that there is a relationship between the number of murders and the temperature, but it is not a very strong one.
