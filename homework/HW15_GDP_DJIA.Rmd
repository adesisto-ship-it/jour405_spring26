...
GDP_data |> 
  ...
  labs(title = "How well do the DJIA and the GDP represent the state of the U.S. Economy?", x="DJIA", y = "GDP")
```
...
The DJIA and GDP are very closely correlated with a specific value of about 0.95. The scatterplot agrees with this value given the highly angled line and minimal error shading. The data does generally follow a trend of higher DJIA = higher GDP but the lower end has the tightest fit. 
