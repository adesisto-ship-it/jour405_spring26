...
One obvious anomaly is the significant dip just after the start of 2020. This is most likely because of COVID-19, which kept people off the roads and in their homes during that time, so there would be less accidents to report. An interesting pattern is the constant fluctuation in the data over each year. For example, there is a dip at the beginning of each year and a dip in the middle of each year. I would think there would be an increase during the winter time, but instead it come as the weather begins to get warmer. It would be interesting to investigate why that is and see if any of these increases line up with certain events. Perhaps the increase correlating to warmer weather is due to more people driving since the cold winter months are over. Since this winter was particularly bad, I would be curious to see if any other winters were bad and saw more snow and if they had an overall higher number of accidents reported because of that. 
...
Friday and Saturday have the highest average of accidents, most likeley as a result of drunk driving or other forms of impaired driving as a result of partying and going out on the weekends. The lowest averages are Monday through Wednesday and likely because there people simply driving to work or school and don't find themselves in a rush or under the influence. 
...
accidents <- accidents |>
  mutate(
    ...
    z_score = (total - sd_accidents) / mean_accidents
  )
...
A quick google search shows that October 29, 2021 saw a very large storm with heavy flooding over the course of a day. This likely led to cars hydroplaning and crashing or heavy rains led to crashes and other single car accidents. The story could be about this extreme weather events of that day and talking to people who experianced property and car damage as a result of the storm.
...
The z-score for the day-of-week are more in the 3 and 4 range whereas the overall z-score is sitting in the 2 range. I think this is due to the fact that within the days of the week, a day with very high or very low number of accidents can be way more dramatically different from the mean for the week and therefore result in a very high (or very low) z-score for that particular day. I think measuring the day-of-week z-scores can present that data in a more appealing way to the reader because the percentages can be more extreme and show how over the course of a particular week, the outlier day was dramatically extreme from the other days that week. 
...
October by far has the highest number of average accidents while january is by far the lowest. My hypothesis for Janurary still stands as it did in the tasks above and it is that the winter keeps more people inside. Despite this winter having more snow, I noticed that when we get extreme snow, people generally stay off the roads and schools and work get canceled for a very long time. (This is not the case in MA, where I am from, and therefore we see more accidents up there as a result of these snow storms) October is a bit more confusing. We saw the example of the one extreme weather event (which might help to bring this average up) but it also may be due to Halloween and other fall holidays that lead to more people out on the roads and more accidents. Having major sporting events like football games could increase this, where you have a lot of people traveling to and from one place at the same time. No other seasons see continous events with this large of a popultion present. The spike in May is interesting. I think it is because as the weather warms and some sever storms hit the area, more people are out and driving which would inherently increase the number of accidents because there is a higher chance of people getting in an accident.
...
There are no days with extreme outliers identified.
...
Pitch: a story about why there are so few crashes in the beginning of the year and why they increase over the course of the year

Headline: Data shows steady increase in average traffic accidents over the course of a year 

Lede: Data from the last five years shows a steady increase in average monthly traffic accidents over the course of the year.

It would be helpful to interview a chief police official to get their take on why they see more or less traffic accidents at certains times. I would also interview "random" everyday people about if they have been involved or witnessed a traffic accident and when to see if the eyewtiness can corroborate the data. Since the data is a little complex, it might be helpful to talk to someone with mroe knowlege who can help to explain what we are seeing here and help to interpret it. Finally, I could talk to a tow truck company to see if they have any sort of similar data since they are also often dealing with these accidents. 
